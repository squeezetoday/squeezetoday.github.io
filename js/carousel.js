class AdCarousel extends HTMLElement {
  ...
  _setupEvents() {
    ...
    // Handle slot changes dynamically (if ads change)
  ...
  _goToSlide(index) {
    ...
    if (this._dots[this._currentIndex]) this._dots[this._currentIndex].classList.add('active');
  }
  ...
  _startAutoSlide() {
    ...
    this._intervalId = setInterval(() => this._goNext(), interval);
  }
